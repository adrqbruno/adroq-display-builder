...
import { state } from "./state.js";import { getScale, ANIM_MAP } from "./constants.js";
...
export async function exportPNG() {
  ...
  try {
    ...
    const dataUrl = await toPng(banner, {
      ...
      style: { transform:`scale(${1/sc})`, transformOrigin:"top left", width:fmt.w+"px", height:fmt.h+"px" },
    });
